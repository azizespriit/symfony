...
if (!$user) {
throw new UsernameNotFoundException("User with email $identifier not found.");
}

// Check if the account is locked
if ($user->getIsLocked()) {
throw new \Symfony\Component\Security\Core\Exception\AuthenticationException('Your account is locked.');
}
