...
class CommandeController extends AbstractController
{
    ...
    public function createFromPanier(Request $request, EntityManagerInterface $entityManager, int $panierId, SessionInterface $session): Response
    {
        // Find the panier
    ...
    public function confirmation(EntityManagerInterface $entityManager, int $id): Response
    {
