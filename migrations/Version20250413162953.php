 ...
 */
final class Version20250413162953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE roles roles JSON NOT NULL COMMENT '(DC2Type:json)', CHANGE createdAt createdAt DATETIME NOT NULL, CHANGE updateAt updateAt DATETIME NOT NULL, CHANGE reset_token reset_token VARCHAR(255) NOT NULL, CHANGE token_expiry token_expiry DATETIME NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE roles roles VARCHAR(255) NOT NULL COLLATE `utf8mb4_bin`, CHANGE createdAt createdAt DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE updateAt updateAt DATETIME DEFAULT NULL, CHANGE reset_token reset_token VARCHAR(255) DEFAULT NULL, CHANGE token_expiry token_expiry DATETIME DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
